          ...
          <div class="card shadow-sm login-card">
            <div class="card-body p-4">
              ...
              <p class="subtext mb-4 text-center">
                Chào mừng quay lại Study Store
              </p>

              <div v-if="serverError" class="alert alert-danger mt-2 mb-3">
                {{ serverError }}
              </div>
              ...
              >
                ...
                <div class="text-center mt-3">
                  ...
                  <RouterLink
                    class="text-decoration-none ms-1 link-main"
                    to="/register"
                  >
                    Đăng ký
                  </RouterLink>
                ...
                <a
                  href="#"
                  class="text-decoration-none text-center d-block mt-2 subtext"
                >
                  Quên mật khẩu?
                </a>
              </Form>
...
async function onSubmit(values, actions) {
  ...
  try {
    ...
    await Swal.fire("Thành công!", "Đăng nhập thành công!", "success");
    router.push("/home");
    return res;
  } catch (e) {
    console.log(e);
    ...
    Swal.fire("Lỗi khi đăng nhập", serverError.value, "error");
  }
}
</script>
