      ...
      <div class="card card-soft">
        <div class="card-body">
          ...
          <template v-else>
            ...
            <div class="row g-3">
              ...
              <div class="col-12 col-md-5">
                ...
                <div class="form-control bg-transparent">
                  {{ receipt?.supplier?.name || receipt?.supplier_name || "—" }}
                </div>
              </div>
                    ...
                    <tr v-for="(it, idx) in receiptItems" :key="idx">
                      ...
                      <td>
                        <div class="d-flex align-items-center gap-2">
                          <div class="thumb">
                            <img
                              v-if="getProductThumb(it.product)"
                              :src="getProductThumb(it.product)"
                              alt="thumb"
                            />
            ...
            <div
              class="row g-3 mt-1"
              v-if="receipt?.created_at || receipt?.updated_at"
            >
              <div class="col-12 col-md-5">
              ...
              <div
                class="d-flex col-12 col-md-3 justify-content-md-end align-items-center mt-2 mt-md-0"
...
const receiptItems = computed(() => {
  return receipt.value?.receipt_details || [];
});
