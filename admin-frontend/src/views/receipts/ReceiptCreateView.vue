            ...
            <div class="row g-3">
              ...
              <div class="col-12">
                          ...
                          <td>
                            ...
                            >
                              ...
                              >
                                ...
                                <option
                                  v-if="getColorsForRow(f.value).length"
                                  value=""
                                >
                                  -- Chọn màu --
                                </option>
                                ...
                                <option
                                  v-for="c in getColorsForRow(f.value)"
                                  :key="c.id"
                                  :value="String(c.id)"
                                >
                                  {{ c.color_name }}
                ...
                <div
                  ...
                  v-if="typeof errors.items === 'string'"
                >
                  {{ errors.items }}
                </div>
...
onMounted(async () => {
  suppliers.value = (
    await SupplierService.getAll({ per_page: 200 })
  ).data.items;
  warehouses.value = (
