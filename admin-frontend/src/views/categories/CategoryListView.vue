<template>
  <div class="row g-3">
    ...
    <div class="col-12">
      ...
      >
        <div>
          <h4 class="mb-1">Danh mục</h4>
          <div class="small opacity-75">Quản lý danh sách danh mục</div>
        </div>
              ...
              <tbody v-if="items.length">
                <tr v-for="c in items" :key="c.id">
                  ...
                  <td class="ps-3">
                    <RouterLink
                      class="name-link"
                      :to="{ name: 'categories.detail', params: { id: c.id } }"
                    >
                  ...
                  <td class="text-end pe-3">
                    <div class="d-flex justify-content-end gap-2">
                      <RouterLink
                        ...
                        :to="{ name: 'categories.edit', params: { id: c.id } }"
                        title="Chỉnh sửa"
                      >
